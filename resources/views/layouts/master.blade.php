...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark navbar-admin fixed-top">
            <div class="container-fluid">
                <a class="navbar-brand" id="colorlib-logo" href="{{ url('/') }}" style="font-size:25px; font-weight:700;">
                    JUKARDO
                </a> {{--
    ...
    <footer class="footer">
        <div class="container">
          <span class="text-muted">JUKARDO &copy; 2018 - POWERED by house603</span>
        </div>
      </footer>
</body>
